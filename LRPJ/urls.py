...
urlpatterns = [
	...
	url(r'^look_others', views_1.look_others, name = 'look_others'),
	url(r'^open_attention', views_1.open_attention, name = 'open_attention'),
	url(r'^close_attention', views_1.close_attention, name = 'close_attention'),
    url(r'^logout', views_1.logout, name = 'logout'),
    url(r'^login', views_1.login, name = 'login'),
	url(r'^choose_room', views_1.choose_room, name = 'choose_room'),
	url(r'^choose_seat', views_1.choose_seat, name = 'choose_seat'),
